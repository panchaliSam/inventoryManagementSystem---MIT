    ...
    <div class="afterNavContent" style="padding-top: 50px; margin-top: 20px; padding-left: 50px; margin-left: 20px;">
      <div class="row" style="margin-left: 0; margin-right: 0;">
          ...
          <div class="col-xs-6 text-left">
            <a href="../PHP/supplierDownload.php" class="btn btn-success">Download CSV</a>
          </div>
          
          <!-- Add Category button aligned to the right -->
          <div class="col-xs-6 text-right">
            <button type="button" class="btn btn-primary" style="padding: 1rem 2rem; border: none; color: white; border-radius: 1rem;" onclick="window.location.href='../PHP/supplierAdd.php';">
              Add Supplier
            </button>
          </div>
        </div>
      ...
      <?php
          include_once "../PHP/supplierView.php"
      ?>
    </div>
