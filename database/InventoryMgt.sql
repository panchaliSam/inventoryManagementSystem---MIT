...
INSERT INTO `category` (`CategoryID`, `Name`, `Quantity`, `IsAvailable`, `Description`) VALUES
	(1, 'Phone', 98, 1, 'Smartphones and accessories'),
	(2, 'Laptop', 49, 1, 'Laptops and accessories'),
	(3, 'Headphone', 205, 1, 'Headphones and earphones'),
...
INSERT INTO `item` (`ItemID`, `Name`, `Quantity`, `PurchasePrice`, `SellingPrice`, `Status`, `Description`, `CategoryID`, `BrandID`) VALUES
	(1, 'iPhone 12', 41, 700, 600, 1, 'Latest iPhone model', 1, 1),
	(2, 'Dell XPS 13', 4, 1000, 1200, 1, '13-inch laptop', 2, 2),
...
-- Dumping data for table inventorymgt.itemhasorder: ~4 rows (approximately)
...
-- Dumping data for table inventorymgt.orders: ~3 rows (approximately)
...
-- Dumping data for table inventorymgt.supplier: ~8 rows (approximately)
INSERT INTO `supplier` (`SupplierID`, `Name`, `Email`, `Telephone`, `Address`) VALUES
	(1, 'TechSupplier Co.', NULL, '5551234567', NULL),
	(2, 'Gadgets Inc.', NULL, '5559876543', NULL),
	(3, 'Electronics World', NULL, '5557654321', NULL);
...
-- Dumping data for table inventorymgt.user: ~3 rows (approximately)
